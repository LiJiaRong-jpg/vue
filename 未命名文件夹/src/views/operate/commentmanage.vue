  ...
  <div>
    <div>
      ...
      <div>
        ...
        <el-button style="position: relative;top: -13px;left: 10px;" class="filter-item" type="primary"
          icon="el-icon-search" @click="load" v-permission="'operation:appraise:query'">查找</el-button>
      </div>
    </div>
    ...
    <el-table :data="tableData.items" style="width: 95%;margin: auto;margin-top: 20px;"
      ...
      <el-table-column align="center" label="操作" prop="type">
        <template slot-scope="scope">
          <el-button type="danger" size="mini" @click="deleteRow(scope)" v-permission="'operation:appraise:delete'">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
