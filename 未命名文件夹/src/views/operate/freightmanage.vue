...
export default {
  ...
  methods: {
    ...
    addTemplate () { // 添加运费模板
      ...
      if (_ress.deliveryDeadline - '' > 0 && _ress.defaultFreePrice - '' > 0 && _ress.defaultFirstNum - '' >= 0 && _ress.defaultContinueNum - '' > 0 && _ress.defaultContinuePrice - '' >= 0 && _ress.templateName.trim() != '' && _ress.spuLocation.trim() != '') {
