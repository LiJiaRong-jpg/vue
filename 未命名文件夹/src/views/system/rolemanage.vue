  ...
  <div class="rolemanage">
    ...
    <div class="filter-container" style="margin-top: 20px;margin-left: 20px;margin-bottom: 20px;">
      ...
      <el-button style="position: relative;top: -13px;left: 10px;" class="filter-item" type="primary"
        icon="el-icon-search" @click="handleFilter" v-permission="'admin:role:list'">查找</el-button>
      <el-button style="position: relative;top: -13px;left: 10px;" class="filter-item" type="primary"
        icon="el-icon-edit" @click="handleCreate" v-permission="'admin:role:create'">添加</el-button>
    </div>
      ...
      <el-table :data="tableData.items" style="width: 90%;margin: auto;" border>
        ...
        <el-table-column prop="address" label="操作" align="center">
          ...
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="handleUpdate(scope.row)" v-permission="'admin:role:update'">
              编辑</el-button>
            <el-button type="danger" size="mini" @click="handleDelete(scope.row)" v-permission="'admin:role:delete'">
              删除</el-button>
            <el-button type="primary" size="mini" @click="handlePermission(scope.row)" v-permission="'admin:role:permissionList'">授权</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <el-dialog title="权限配置" :visible.sync="Authorization">
      <el-tree ref="auth" :data="authorization.systemPermissions" show-checkbox
        :default-checked-keys="authorization.assignedPermissions" node-key="id">
      </el-tree>
      <div style="float: right;">
