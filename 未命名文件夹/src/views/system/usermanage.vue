<template>
  <div style="padding-left: 20px;">
    ...
    <div>
      ...
      <el-button type="primary" icon="el-icon-search" @click="load" v-permission="'system:user:query'">查找
      </el-button>
      <el-button type="primary" icon="el-icon-edit" @click="AddUser" v-permission="'system:user:create'">添加用户
      </el-button>
    </div>
    ...
    <el-table :data="tableData.items" style="width: 95%;margin: auto;margin-top: 20px;"
      ...
      <el-table-column prop="address" label="操作" align="center" width="250">
        <!-- :formatter="formatter" -->
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="statusUpdate(scope)" v-permission="'system:user:update'">
            {{ scope.row.status === 0 ? "激活" : "冻结" }}
          </el-button>
          <el-button type="primary" size="mini" @click="handleUpdate(scope)" v-permission="'system:user:update'">
            编辑</el-button>
          <el-button type="danger" size="mini" @click="handleDelete(scope)" v-permission="'system:user:delete'">
            删除</el-button>
        </template>
      </el-table-column>
    </el-table>
